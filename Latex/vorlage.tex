...
\author{Daniel Schreiber 957819, Tobias Meyering 954574, Joscha W"ulk 958193, Benjamin R"atze 954436, Tobias R"uhl 957798, Alexander Hanf } 							% Autor der Arbeit
...
\input{chapters/SquadBuilder}
\input{chapters/Levelaufbau}
\input{chapters/ManagerObjekt}
\input{chapters/Spieler}
\input{chapters/Spielfiguren}
\input{chapters/Pathfinding}
\input{chapters/Kamera}
\input{chapters/UI}
\input{chapters/3dmodelling}
\input{chapters/Animationen}
\input{chapters/Sounds}
\input{chapters/Effekte}
\input{chapters/StatusQuo}
